...
public class OrderTestData {
    ...
    public static final int ORDER1_ID = START_SEQ + 9;
    ...
    public static Order getNew() {
        return new Order(null,
                LocalDateTime.of(2020, Month.OCTOBER, 12, 10, 0), 1, OrderStatus.PROCESSING, 0);
    }
