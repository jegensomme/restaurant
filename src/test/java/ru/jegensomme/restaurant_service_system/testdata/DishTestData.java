...
public class DishTestData {
    ...
    public static final Dish DISH1 = new Dish(DISH1_ID, "Dish1", DISH_CATEGORY1, 2000);
    public static final Dish DISH2 = new Dish(DISH2_ID, "Dish2", DISH_CATEGORY1, 3000);
    public static final Dish DISH3 = new Dish(DISH3_ID, "Dish3", DISH_CATEGORY2, 2000);
    public static final Dish DISH4 = new Dish(DISH4_ID, "Dish4", DISH_CATEGORY2, 3000);

    public static Dish getNew() {
        return new Dish(null, "New", DISH_CATEGORY1, 1000);
    }
